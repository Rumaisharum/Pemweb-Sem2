...
<body>
    <div class="container px-5 my-5">
        <form action="daftar_mahasiswa.php" method="POST">
            ...
            <div class="mb-3">
                <label class="form-label" for="Tahun Angkatan">Tahun Angkatan</label>
                <input class="form-control" name="angkatan" type="text" placeholder="Tahun Angkatan" data-sb-validations="required" />
